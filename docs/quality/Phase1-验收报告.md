...
[benchmark-baseline-2026-08-29.md](../../openspec/changes/archive/2026-08-29-phase1-audit-remediation/evidence/benchmark-baseline-2026-08-29.md)：无竞争 tryLock 往返 ~11.3k ops/s（P50 0.04ms / P99 0.10ms）；16 线程竞争 ~11.4k ops/s（授予延迟 P99 ~2.0ms）；64 线程 ~11.3k ops/s（P99 ~8.7ms）。按 §10.5 仅作防退化参考，不设发布门槛。
